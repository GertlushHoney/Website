  ...
  return (
    <section className="border-ink-line bg-honeycomb-surface grid items-stretch border-b lg:grid-cols-2">
      <div className="flex flex-col justify-center px-6 py-16 lg:px-16">
        ...
        <Link
          href="/postcode-honey"
          className="border-porcelain/40 bg-porcelain/10 text-porcelain hover:bg-porcelain/20 hover:border-porcelain focus-visible:outline-honey-amber mt-8 inline-block w-fit rounded-full border px-6 py-2.5 text-sm font-semibold focus-visible:outline focus-visible:outline-offset-4"
        >
